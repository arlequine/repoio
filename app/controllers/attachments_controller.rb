class AttachmentsController < ApplicationController
  ...
  def create
    ...
    if @attachment.save
      redirect_to @attachment.product,notice: "Archivo adjunto guardado :) "
    else
      redirect_to @product, notice: "Error al guardar archivo adjunto D: "
    end
  end
  ...
  private
    ...
    def authenticate_owner!
      ...
      if @product.nil? || @product.user != current_user
        redirect_to root_path, notice: "Ohh! Valida si eres el dueño!"
        return
      end
    end
